...
func (d *ExampleChildDriver) Protocols() []driversdk.Protocol { return []driversdk.Protocol{driversdk.ProtocolZigbee} }
func (d *ExampleChildDriver) Topologies() []driversdk.Topology { return []driversdk.Topology{driversdk.TopologyViaHub} }
...
func (d *ExampleChildDriver) Endpoints() ([]driversdk.Endpoint, error) {
  ...
  return []driversdk.Endpoint{
    { Key:"power", Name:"Power", Direction:"BIDIR", Type:"switch", ValueSchema: sch },
  }, nil
}

func (d *ExampleChildDriver) Variables() ([]driversdk.Variable, error) {
  return []driversdk.Variable{
    { Key:"lqi", Type:"integer", Unit:"", ReadOnly:true },
  }, nil
}
...
func (d *ExampleChildDriver) Stop(ctx context.Context) error {
  if d.hostProxy != nil { _ = d.hostProxy.Close() }
