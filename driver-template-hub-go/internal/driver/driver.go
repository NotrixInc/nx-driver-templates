...
func (d *ExampleHubDriver) Protocols() []driversdk.Protocol {
	return []driversdk.Protocol{driversdk.ProtocolIP}
}
func (d *ExampleHubDriver) Topologies() []driversdk.Topology {
...
func (d *ExampleHubDriver) Init(ctx context.Context, deps driversdk.Dependencies, cfg driversdk.JSONConfig) error {
	...
	if d.cfg.IP == "" {
		return fmt.Errorf("config.ip required")
	}
...
func (d *ExampleHubDriver) Endpoints() ([]driversdk.Endpoint, error) {
	...
	return []driversdk.Endpoint{
		{Key: "permit_join", Name: "Permit Join", Direction: driversdk.EndpointDirectionOutput, Kind: driversdk.EndpointKindControl, Connection: driversdk.EndpointConnectionIP, Icon: "ip", MultiBinding: false, ControlType: "toggle", ValueSchema: sch},
	}, nil
}

func (d *ExampleHubDriver) Variables() ([]driversdk.Variable, error) {
	return []driversdk.Variable{
		{Key: "child_count", Type: driversdk.VariableTypeNumber, Unit: "", Readable: true, Writable: false},
	}, nil
}
...
func (d *ExampleHubDriver) startHubGatewaySession() {
	...
	d.deps.Logger.Info("hub session opened", "hub_device_id", d.deviceID)
