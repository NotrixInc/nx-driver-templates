...
import (
	...
	"github.com/NotrixInc/nx-driver-templates/drivers/com.notrix.w2io/internal/driver"
	"github.com/NotrixInc/nx-driver-templates/drivers/com.notrix.w2io/internal/publisher"
)
...
func main() {
	...
	d := driver.NewW2IODriver(*deviceID)
