...
import (
	...
	"github.com/NotrixInc/nx-driver-templates/drivers/light_cct-go/internal/driver"
	"github.com/NotrixInc/nx-driver-templates/drivers/light_cct-go/internal/publisher"
)
...
func main() {
	...
	d := driver.NewLightCCTDriver(*deviceID)
